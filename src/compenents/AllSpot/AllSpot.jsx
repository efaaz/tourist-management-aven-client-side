          ...
          <div key={spot._id} className="mb-4">
            ...
            <div className="card-body">
              <div className="flex justify-between">
                ...
                <div>
                <p className="font-bold text-base text-yellow-500">{spot.country_name}</p>
                </div>
              </div>
              <h2 className="card-title font-bold">{spot.tourists_spot_name}</h2>
              
              <hr />
              <div className="flex gap-1 text-lg items-center font-semibold text-gray-700 mt-1">
              <IoIosTime></IoIosTime>
              <p className="font-semibold text-base">Travle time: {spot.travel_time}</p>
              </div>
